...
def main(argv: List[str] | None = None) -> None:
    ...
    if args.range_mode == "single":
        ...
        make_compilation_pdf(
            ...
            back_cover_catch_enabled=args.back_cover_catch_enabled,
            interstitial_source=args.interstitial_source,
